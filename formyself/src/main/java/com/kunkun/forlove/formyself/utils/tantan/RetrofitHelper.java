package com.kunkun.forlove.formyself.utils.tantan;
...
public class RetrofitHelper {
        ...
        okHttpClient = new OkHttpClient.Builder()
                ...
                .addInterceptor(new Interceptor() {
                    ...
                    public Response intercept(Chain chain) throws IOException {
                        ...
                        Log.w(TAG, "request " + originalHttpUrl);
    ...
    public static <T> void call(Call<BaseModel<T>> call) {
        call(call, new SimpleApiCallback<T>());
    }
        ...
        call.enqueue(new Callback<BaseModel<T>>() {
            ...
            public void onResponse(Call<BaseModel<T>> call, retrofit2.Response<BaseModel<T>> response) {
                ...
                if (response.code() == HttpURLConnection.HTTP_FORBIDDEN) {
                    Log.d(TAG, "call() fail， onForbidden");
                    if (callback != null) {
                ...
                if (!response.isSuccessful()) {
                    Log.d(TAG, "call() fail， !isSuccessful");
                    if (callback != null) {
                ...
                if (model.error) {
                    Log.d(TAG, "call() fail， model.error = true");
                    if (callback != null) {
                ...
                if (!allowNull && data == null) {
                    Log.d(TAG, "call() fail， data == null ");
                    callback.onLoadFail(-100);
                    return;
                }

                Log.d(TAG, "call success, result = " + ((data instanceof Collection) ? ((Collection) data).size() : data));
                if (callback != null) {
            ...
            public void onFailure(Call<BaseModel<T>> call, Throwable t) {
                Log.d(TAG, "call() fail. onFailure --> ", t);
                callback.onLoadFail(STATUS_HTTP_ERROR);
            }
        });
    }
